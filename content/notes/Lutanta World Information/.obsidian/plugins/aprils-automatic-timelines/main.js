...
async function extractCardData(context) {
  ...
  const fileTitle = ((_a2 = c == null ? void 0 : c.frontmatter) == null ? void 0 : _a2[settings.metadataKeyEventTitleOverride]) || file.basename;
  return {
    title: fileTitle,
...
function getBodyFromContextOrDocument(rawFileText, context) {
  ...
  const overrideBody = (_a2 = metadata == null ? void 0 : metadata[metadataKeyEventBodyOverride]) != null ? _a2 : null;
...
function getAbstractDateFromMetadata({ cachedMetadata, settings }, key) {
  ...
  if (!stringValue)
    return void 0;
  const matches2 = stringValue.match(settings.dateParserRegex);
...
function formatAbstractDate(date, { dateDisplayFormat, dateParserGroupPriority }) {
...
function withMemo(memo, render6, cache2, index) {
...
function emitError(context, code3, offset, loc = getCursor(context)) {
  ...
  context.options.onError(createCompilerError(code3, {
    start: loc,
    end: loc,
    source: ""
  }));
...
function createDOMCompilerError(code3, loc) {
  return createCompilerError(code3, loc, true ? DOMErrorMessages : void 0);
}
...
${codeFrame}` : message);
  ...
  const render6 = new Function("Vue", code3)(runtime_dom_esm_bundler_exports);
  render6._rc = true;
...
var VInput_default = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose, emit: emit2 }) {
    ...
    function handleInputEvent(event) {
      if (!event.target)
        return;
      emit2("update:value", event.target.value);
    }
    const __returned__ = { emit: emit2, handleInputEvent };
...
var _hoisted_1 = { class: "v-input-wrap" };
var _hoisted_2 = ["for"];
var _hoisted_3 = { class: "setting-item-description" };
...
function render3(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1, [
    createBaseVNode("div", null, [
      ...
      createBaseVNode("summary", _hoisted_3, [
...
var _hoisted_12 = { class: "v-input-wrap v-checkbox" };
var _hoisted_22 = ["for"];
...
VCheckbox_default.render = render4;
...
var VSettings_default = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose, emit: emit2 }) {
    ...
    const __returned__ = { props, emit: emit2, settingKeys, fantasyCalendarPreset, fantasyCalendarKeys, keysAreCompliantWithFcPreset, handleUpdateValueFantasyCalendarCheckbox, VHeader: VHeader_default, VInput: VInput_default2, VCheckbox: VCheckbox_default2 };
    Object.defineProperty(__returned__, "__isScriptSetup", { enumerable: false, value: true });
    return __returned__;
  }
});
...
var _hoisted_13 = { class: "v-grid-display" };
var _hoisted_23 = { class: "v-grid-display" };
...
var _hoisted_5 = /* @__PURE__ */ createBaseVNode(
  "a",
  ...
  return openBlock(), createElementBlock("div", _hoisted_13, [
    createBaseVNode("section", _hoisted_23, [
      ...
      (openBlock(true), createElementBlock(
        Fragment,
        null,
        renderList($setup.settingKeys, (key) => {
...
VSettings_default.render = render5;
...
var TimelineSettingTab = class extends import_obsidian3.PluginSettingTab {
  ...
  display() {
    ...
    createApp({
      components: { VSettings: VSettings_default2 },
      ...
      methods: {}
    }).use(i18n).mount(this.containerEl);
  }
};
